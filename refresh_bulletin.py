...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  /* kpis */
  .kpis{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;padding:6px 20px 4px;}
  .kpi{background:linear-gradient(180deg,#fff,#fafcfe);border:1px solid var(--line);border-radius:13px;padding:10px 12px;min-width:0;overflow:hidden;}
  .k-top{display:flex;align-items:center;gap:7px;color:var(--mut);font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.04em;flex-wrap:nowrap;min-width:0;}
  .k-top svg{color:#fff;flex:none;}
  .k-top span{color:var(--mut);min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
  .kpi .k-top .k-ic{width:26px;height:26px;border-radius:8px;display:grid;place-items:center;color:#fff;flex:none;}
  ...
  .live{font-style:normal;font-size:8px;color:#ff6b35;background:#fff1ea;border-radius:99px;padding:1px 6px;margin-left:auto;flex:none;}
  .k-val{font-family:'Sora',sans-serif;font-size:21px;font-weight:800;margin-top:6px;font-variant-numeric:tabular-nums;min-width:0;overflow:hidden;text-overflow:ellipsis;}
  .k-unit{font-size:10px;color:#94a3b5;margin-top:1px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
  .mp-ctrl{display:flex;align-items:center;gap:4px;margin-top:7px;min-width:0;}
  .mp-btn{flex:0 0 32px;width:32px;height:34px;border-radius:9px;border:1px solid var(--line2);background:#fff;color:var(--navy);
          font-size:19px;font-weight:800;cursor:pointer;display:grid;place-items:center;padding:0;}
  .mp-btn:active{transform:scale(.92);}
  .mp-input{flex:1 1 auto;min-width:0;width:auto;height:34px;border:1px solid var(--line2);border-radius:9px;text-align:center;
  ...
  @media (max-width:820px){
    ...
    .kpis{grid-template-columns:repeat(2,minmax(0,1fr));padding:6px 14px 2px;}
